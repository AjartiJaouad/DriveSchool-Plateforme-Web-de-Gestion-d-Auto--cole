        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <div class="mt-2 px-7 py-3 text-left text-sm text-gray-500">
                    ...
                    <div id="actionButtons" class="flex justify-between space-x-2">
                    ...
                    <div class="mt-4">
                        <a id="editLink" href="#" class="hidden inline-flex items-center justify-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700">Modifier la séance</a>
                        <a id="viewCandidatLink" href="#" class="hidden ml-2 inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-700 shadow-sm hover:bg-gray-50">Voir le candidat</a>
                    </div>
                </div>
                <div id="evaluationSection" class="mt-4 pt-4 border-t border-gray-200 text-left">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(info) {
                ...
                var editUrl = "{{ url('moniteur/seances') }}/" + seanceId + "/edit";
                var candidateRouteTemplate = "{{ route('moniteur.candidats.show', ['candidat' => 'CANDIDAT_ID']) }}";
                var viewCandidatUrl = candidateRouteTemplate.replace('CANDIDAT_ID', eventObj.extendedProps.candidatId);
                ...
                document.getElementById('viewCandidatLink').href = viewCandidatUrl;

                var isSeance = eventObj.extendedProps.eventType === 'seance';
                document.getElementById('editLink').classList.toggle('hidden', !isSeance);
                document.getElementById('viewCandidatLink').classList.toggle('hidden', !isSeance || !eventObj.extendedProps.candidatId);
                document.getElementById('evaluationSection').classList.toggle('hidden', !isSeance);
                document.getElementById('actionButtons').classList.toggle('hidden', !isSeance);
