            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                <form action="{{ route('admin.moniteurs.update', $moniteur) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="matricule" value="{{ old('matricule', $moniteur->matricule) }}" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 font-semibold text-sm mb-1">Téléphone</label>
                        <input type="text" name="telephone" value="{{ old('telephone', $moniteur->telephone) }}" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                    ...
                    <div class="mb-4 flex items-center gap-3">
                        <input type="checkbox" name="actif" id="actif" value="1" {{ old('actif', $moniteur->actif) ? 'checked' : '' }}>
                        <label for="actif" class="text-gray-700 font-semibold text-sm">Actif</label>
                    </div>
